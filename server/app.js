...
app.post('/upload', upload.single('image'), (req, res) => {
  ...
  const imageUrl = `${process.env.VITE_REACT_APP_BACKEND_BASEURL}/uploads/${req.file.filename}`
...
app.post('/testimonial', upload.single('image'), (req, res) => {
  ...
  const img_url = req.file
    ? `${process.env.VITE_REACT_APP_BACKEND_BASEURL}/uploads/${req.file.filename}`
    : null
